...
def resource_path(relative_path):
    """Get the correct path whether running as script or bundled exe."""
    if hasattr(sys, '_MEIPASS'):
        # Running as bundled exe — temp extraction folder
...
def main():
    ...
    bottle    = OBJ(resource_path(os.path.join("Assets", "almond_bottle.obj")))
